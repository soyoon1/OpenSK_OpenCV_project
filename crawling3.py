...
createFolder(f'project/dataset/{searchKey}')

service = Service(executable_path="C:/chromedriver-win64/chromedriver.exe")
driver = webdriver.Chrome(service=service)  #chromedriver.exe -> 가져 옴
...
for image in images:
    try:
        ...
        urllib.request.urlretrieve(imgUrl, f'project/dataset/{searchKey}/{str(count)}.jpg') # url을 
        count = count + 1
